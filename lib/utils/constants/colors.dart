...
class TColors {
  ...
  static const Color darkContainer = Color(0x1AFFFFFF); // White with 10% opacity
  ...
  static const Color info = Color(0xFF2976D2);
  ...
  static const Color lighttGrey = Color(0xFFF9F9F9);
